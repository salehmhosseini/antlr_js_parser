...
public interface grammer_parserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link grammer_parser#logicalAndExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLogicalAndExpression(grammer_parser.LogicalAndExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link grammer_parser#equalityExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEqualityExpression(grammer_parser.EqualityExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link grammer_parser#relationalExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRelationalExpression(grammer_parser.RelationalExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link grammer_parser#additiveExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAdditiveExpression(grammer_parser.AdditiveExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link grammer_parser#multiplicativeExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMultiplicativeExpression(grammer_parser.MultiplicativeExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link grammer_parser#unaryExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUnaryExpression(grammer_parser.UnaryExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link grammer_parser#powerExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPowerExpression(grammer_parser.PowerExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link grammer_parser#primaryExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrimaryExpression(grammer_parser.PrimaryExpressionContext ctx);
}